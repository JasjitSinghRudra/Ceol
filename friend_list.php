...
<center>
  <h1 class="display-6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Friends</h1>
    <p class="lead">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; This is a list of your friends. You can add or remove friends here.</p>
  <ul class="list-group" style="margin-left: 30%; margin-right: 30%; text-align: left;">
  <li class="list-group-item">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sabo<button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#myModal" style="margin-left: 70%;">Remove</button></li>
  <li class="list-group-item">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nami&nbsp;<button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#myModal" style="margin-left: 69%;">Remove</button></li></li>
  <li class="list-group-item">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sanji&nbsp;<button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#myModal" style="margin-left: 70%;">Remove</button></li></li>
    <li class="list-group-item">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Roronoa Zoro<button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#myModal" style="margin-left: 60%">Remove</button></li></li>
  <li class="list-group-item">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Luffy❤️<button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#myModal" style="margin-left: 67%;">Remove</button></li></li>
  <li class="list-group-item">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Garp<button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#myModal" style="margin-left: 71%;">Remove</button></li></li>
    <li class="list-group-item">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Whitebeard<button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#myModal" style="margin-left: 63%">Remove</button></li></li>
  <li class="list-group-item">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kaido<button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#myModal" style="margin-left: 400px;">Remove</button></li></li>
